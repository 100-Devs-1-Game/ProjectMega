...
func get_chunk_data_at_position(pos: Vector2)-> MapChunkData:
	var chunk_coords: Vector2i = get_chunk_coords(pos)
...
static func get_chunk_coords(pos: Vector2)-> Vector2i:
